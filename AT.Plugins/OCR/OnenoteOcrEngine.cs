...
{
    public class OnenoteOcrEngine : IOcrEngine,IDisposable
    {
        ...
        {
            this._app = this.Try(() => new Application(), e => new OcrException("Error initializing OneNote", e));
            this._page = this.Try(() => new OnenotePage(_app), e => new OcrException("Error initializing page.", e));
    ...
    internal sealed class OnenotePage
    {
        ...
        public void Delete()
        {
            ...
            //this._app.CloseNotebook("452AC71A-B655-4967-A208-A4CC39DD7949");
        }
